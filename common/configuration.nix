...

{
  ...
  # ==========================================================================
  # 1. NIX, FLAKES, CACHES & OPTIMISATION
  # ==========================================================================
  nix = {
    settings = {
      ...
      # Token GitHub (sops) pour éviter le rate-limit
    ...
    # Optimisation périodique du store (hardlinks) → économie d'espace
  ...
  # ==========================================================================
  # 4. RÉSEAU, LOCALISATION, AUDIO & SERVICES DE BASE
  # ==========================================================================
  networking = {
    hostName = "ZenBook-13";
    networkmanager = {
  ...
  hardware.bluetooth = {
    enable = true;
    powerOnBoot = true;   # on laisse pour l’instant
  };
  ...
  # ==========================================================================
  # 6. SESSIONS GRAPHIQUES (Hyprland + Niri + Noctalia)
  # ==========================================================================
